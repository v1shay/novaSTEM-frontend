...
export function Experience() {
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-screen pt-24 pb-12">
      ...
      <motion.div 
        ...
        className="mb-12 flex items-center gap-4 bg-white/5 backdrop-blur-md px-8 py-4 rounded-full border border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.05)]"
      >
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-center perspective w-full">
